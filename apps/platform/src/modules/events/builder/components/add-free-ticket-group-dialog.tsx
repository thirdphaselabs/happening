...
export function AddFreeTicketGroupDialog() {
  ...
  const schema = z.object({
    ...
    availableTo: z.date({
      invalid_type_error: "Available to must be a date",
      ...
      <Dialog.Container>
        <FormProvider {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <Dialog.Content>
              <Dialog.Title>Add free ticket group</Dialog.Title>
              <Flex direction="column" gap="4" maxWidth="550px">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <TextFieldRoot>
                        <TextFieldLabelContainer>
                          <TextFieldLabel>Available from</TextFieldLabel>
                          <FormMessage />
                        </TextFieldLabelContainer>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <TextFieldRoot>
                      <TextFieldLabelContainer>
                        <TextFieldLabel>Available to</TextFieldLabel>
                      </TextFieldLabelContainer>
